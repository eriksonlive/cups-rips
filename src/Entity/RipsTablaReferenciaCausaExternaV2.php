...
#[ORM\Entity(repositoryClass: RipsTablaReferenciaCausaExternaV2Repository::class)]
class RipsTablaReferenciaCausaExternaV2
{
    #[ORM\Id]
    ...
    #[ORM\OneToMany(mappedBy: "causa_externa", targetEntity: AsConsultasProcedimientos::class)]
    ...
    public function removeConsultaProcedimiento(AsConsultasProcedimientos $consulta): self
    {
        if ($this->consultasProcedimientos->removeElement($consulta)) {
            if ($consulta->getCausaExterna() === $this) {
                $consulta->setCausaExterna(null);
            }
        }
        return $this;
    }
