 ...
 */
class getRipsTablaReferenciaCausaExternaV2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RipsTablaReferenciaCausaExternaV2Repository' shared autowired service.
     *
     * @return \App\Repository\RipsTablaReferenciaCausaExternaV2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RipsTablaReferenciaCausaExternaV2Repository.php';

        return $container->privates['App\\Repository\\RipsTablaReferenciaCausaExternaV2Repository'] = new \App\Repository\RipsTablaReferenciaCausaExternaV2Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
