 ...
 */
class getAsConsultasProcedimientosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AsConsultasProcedimientosRepository' shared autowired service.
     *
     * @return \App\Repository\AsConsultasProcedimientosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AsConsultasProcedimientosRepository.php';

        return $container->privates['App\\Repository\\AsConsultasProcedimientosRepository'] = new \App\Repository\AsConsultasProcedimientosRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
