 ...
 */
class getRipsTablaReferenciaFinalidadConsultaV2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RipsTablaReferenciaFinalidadConsultaV2Repository' shared autowired service.
     *
     * @return \App\Repository\RipsTablaReferenciaFinalidadConsultaV2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RipsTablaReferenciaFinalidadConsultaV2Repository.php';

        return $container->privates['App\\Repository\\RipsTablaReferenciaFinalidadConsultaV2Repository'] = new \App\Repository\RipsTablaReferenciaFinalidadConsultaV2Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
